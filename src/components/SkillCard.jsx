...
const SkillCard = ({ skill, percentage, color, move }) => {
  ...
  return (
    <div
      className={`border border-[rgba(255,255,255,.3)] rounded-md px-8 py-3 cursor-pointer group w-full md:w-[40%] flex items-center justify-between relative gap-2`}
      style={{
    ...
    >
      ...
      <div className="flex-1 flex-col items-start justify-start flex gap-2">
        ...
        <div className="w-full h-1 rounded-md overflow-hidden bg-[rgba(255,255,255,.3)] relative">
          <motion.div
            initial={{ width: 0 }}
      ...
      {/* percentage */}
      <div
        className="w-16 h-12 rounded-md relative overflow-hidden flex justify-center items-center"
